...
/* FineFactor is the relation between Ray's internal beats and Dave Oppenheim's.
Ray's beats are (3 * 5 * 7 * 64) to the quarter note and his are LCDsPerBeat */

#define FineFactor (long)((3 * 5 * 7 * 64) / LCDsPerBeat)

struct QNote {
	long EventTimEX;			/* Time into measure it comes on/off, in Ray's beats */
	union {
