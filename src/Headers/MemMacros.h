...
#define DynamicCROSSSTAFF(link)		( (GetPADYNAMIC(link))->crossStaff)
#define DynamicDMODCODE(link)		( (GetPADYNAMIC(link))->dModCode)
...
#define GRNoteARTHARMONIC(link)		( (GetPAGRNOTE(link))->artHarmonic)
...
#define GRNoteRESERVEDN(link)		( (GetPAGRNOTE(link))->reservedN)
#define GRNoteREST(link)			( (GetPAGRNOTE(link))->rest )
#define GRNoteSEGMENT(link, num)	( (GetPAGRNOTE(link))->nhSegment[num])	
...
#define GRNoteUSERID(link)			( (GetPAGRNOTE(link))->userID)
...
#define NoteRSPIGNORE(link)			( (GetPANOTE(link))->rspIgnore )	
#define NoteSEGMENT(link, num)		( (GetPANOTE(link))->nhSegment[num])	
...
#define NoteUSERID(link)			( (GetPANOTE(link))->userID)	
