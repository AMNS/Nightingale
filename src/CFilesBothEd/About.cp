...
#define	PAUSE_CODE				'π'	/* [opt-p] If line of TEXT resource begins with this,
													animation will pause at this line (cf. SCROLL_PAUSE_DELAY). */
#define	BOLD_CODE				'∫'	/* [opt-b] If this begins a line of TEXT resource, or follows
		...
		switch(itemHit) {
			...
			case BUT2_Special:
#ifdef NOTYET
				{
					...
					if (doc!=NULL)
						DCheckEverything(doc, maxCheck, minCheck);	/* ??Requires Consolation™ */
				}
#else
